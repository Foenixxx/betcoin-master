...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("node 1", "dns1.bet.tech"));
        vSeeds.push_back(CDNSSeedData("node 2", "dns2.bet.tech"));
        vSeeds.push_back(CDNSSeedData("node 3", "dns3.bet.tech"));


        // Bet addresses start with 'z'
