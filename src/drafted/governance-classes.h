 ...
 *
 *   // network
 *   CBetNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bet.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBetNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BetNetwork
// //   -- signature requirements : Key1(User)
// class CBetNetworkVariable : public CGovernanceObject
// {
// private:
