    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bet Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bet Core"));
...
All the Bet in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 Bet, 0.1 Bet, 1 Bet and 10 Bet -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://betpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://betpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bet Core is shutting down...") + "<br /><br />" +
