    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("Bet-light"), QVariant("light"));
/*    ui->theme->addItem(QString("Bet-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("Bet-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("Bet-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("Bet-traditional"), QVariant("trad"));
*/    
    /* Language selector */
