...
This mechanism has been integrated into Bitcore-Node-Bet which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/betpay/insight-api-bet#web-socket-api](https://github.com/betpay/insight-api-bet#web-socket-api)
* API: [https://github.com/betpay/insight-api-bet#instantsend-transactions](https://github.com/betpay/insight-api-bet#instantsend-transactions)
...
By default, the Bet Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bet Core daemon:
