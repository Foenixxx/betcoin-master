...
Only requiring some minor changes is bet.cpp.
...
Changes to bet.cpp
----------------------
bet.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
